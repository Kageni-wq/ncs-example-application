...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DT_HAS_ADC_KEYS_ENABLED, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PUUWAI, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BOARD_PUUWAI_NRF5340_CPUAPP, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_INPUT_ADC_KEYS, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_LOG_THREAD_ID_PREFIX, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_STETHY, 1);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SYSTEM_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MODULE_SYSTEM_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_PUBLISH_THREAD_PRIO, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BUTTON_MSG_SUB_THREAD_PRIO, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DEVICE_MSG_SUB_THREAD_PRIO, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_THREAD_PRIO, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DEVICE_MSG_SUB_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_SYSTEM_THREAD_STACK_SIZE, 1024);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DEVICE_MSG_SUB_QUEUE_SIZE, 4);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX_PARAMS_PER_EVENT, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX_PARAM_LENGTH, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_MAX_EVENT_LENGTH, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_RX_BUF_SIZE, 64);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_UART_RX_TIMEOUT_MS, 100);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ATM_AUDIO_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BTM_AUDIO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BTM_AUDIO_LOG_LEVEL, 3);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DSP_AUDIO_LOG_LEVEL_DEFAULT, 1);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DSP_AUDIO_LOG_LEVEL, 3);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BTM_AUDIO_THREAD_PRIO, 5);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DSP_AUDIO_THREAD_PRIO, 5);
...
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_BTM_AUDIO_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_DSP_AUDIO_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_AUDIO_MSG_SUB_QUEUE_SIZE, 4);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_ZSW_PMIC_BATTERY_CUTOFF_VOLTAGE_MV, 3300);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMIC_STACK_SIZE, 1024);
GEN_ABSOLUTE_SYM_KCONFIG(CONFIG_PMIC_THREAD_PRIO, 5);
